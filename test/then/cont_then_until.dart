...
void main() {
  group('Cont.thenUntil', () {
    ...
    test('succeeds with first value when predicate is true', () {
      int? value;
  ...
  group('Cont.thenUntil0', () {
    test('loops until zero-argument predicate returns true', () {
      int counter = 0;
      int? value;
    ...
    test('behaves like thenUntil with ignored value', () {
      ...
      Cont.fromDeferred<(), int>(() {
        counter1++;
        return Cont.of(counter1);
      }).thenUntil0(() => counter1 >= 3).run((), onThen: (_) {});

      Cont.fromDeferred<(), int>(() {
        counter2++;
        return Cont.of(counter2);
      }).thenUntil((_) => counter2 >= 3).run((), onThen: (_) {});
  ...
  group('Cont.thenUntilWithEnv0', () {
    ...
    test('behaves like thenUntilWithEnv with ignored value', () {
      int counter1 = 0;
      int counter2 = 0;
